...
--20)Dispay user whose id is less than 130
select id,name from students s 
where id < 130;

--21)Display user whose id is less than 127 or grater than 188
select id ,name from students s
where id < 127 or id > 188;

--22)Display the user whose id is less than or egual to 137
select id ,name from students 
where id <= 137;

--23)Display the user whose id is greater than or egual to 137
select id ,name from students
where id >=137;

--24)Display a user whose id is greater than 180 but less than 190
select id, name from students s
where id > 180 and < 190;
...
--27)Display users where created_on egual 2020-10-03 00:00:00,2021-05-19 00:00:00,2021-03-26 00:00:00
select id ,name from students s 
